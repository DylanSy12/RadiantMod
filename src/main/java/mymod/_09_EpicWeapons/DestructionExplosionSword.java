...
public class DestructionExplosionSword extends ItemSword {
	private int explosionType;
//	private float amount;
	private int amount;
	private boolean using;
	private boolean switching;
	public DestructionExplosionSword() {
		super(Main.destructionExplosionSwordMaterial);
					...
					for (int i=0;i<(int)(this.amount/10);i++) {
						switch (this.explosionType) {
							case 0:
								...
								break;
							case 1:
								Codakid.spawnEntity(worldIn, pos, new EntityRadiantGrenade(worldIn));
								break;
							case 2:
								Codakid.spawnEntity(worldIn, pos, new EntityRadiantBuildGrenade(worldIn));
								break;
							case 3:
								Codakid.spawnEntity(worldIn, pos, new EntityRadiantClusterGrenade(worldIn));
								break;
							case 4:
								Codakid.spawnEntity(worldIn, pos, new EntityMysticalEraserGrenade(worldIn));
								break;
							case 5:
							...
							case 6:
								...
								break;
							case 7:
								Codakid.spawnEntity(worldIn, pos, new EntityGodClusterGrenade(worldIn));
								break;
							case 8:
								Codakid.spawnEntity(worldIn, pos, new EntityGodEraserGrenade(worldIn));
								break;
							case 9:
								Codakid.spawnEntity(worldIn, pos, new EntityDestructionEraserGrenade(worldIn));
								break;
							case 10:
								Codakid.spawnEntity(worldIn, pos, new EntityDestructionBuildGrenade(worldIn));
								break;
							case 11:
								Codakid.spawnEntity(worldIn, pos, new EntityDestructionTNTGrenade(worldIn));
								break;
						}
