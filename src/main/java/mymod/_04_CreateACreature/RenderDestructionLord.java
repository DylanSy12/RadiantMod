...
//			Main.MODID, "mobs/destruction_biped_texture.png");
	...
	public RenderDestructionLord(RenderManager renderManager) {
...
//	}
//	
	public static class Factory implements IRenderFactory<DestructionLord> {

        @Override
        public Render<? super DestructionLord> createRenderFor(RenderManager manager) {
            return new RenderDestructionLord(manager);
        }
