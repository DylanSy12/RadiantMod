...
//			Main.MODID, "mobs/mystical_biped_texture.png");
	...
	public RenderMysticalLord(RenderManager renderManager) {
...
//	}
	...
	public static class Factory implements IRenderFactory<MysticalLord> {

        @Override
        public Render<? super MysticalLord> createRenderFor(RenderManager manager) {
            return new RenderMysticalLord(manager);
        }
