...
public class RadiantLuckyBlock extends Block {
	
	public RadiantLuckyBlock() {
...
//		number=273;
		...
		{
			world.setBlockState(pos, Main.radiantOre.getDefaultState());
		}
		else if(number <= 47)
		{
...
//			Codakid.spawnItem(world, pos, Items.IRON_NUGGET, 6);
		...
		else if(number <= 118)
		{
			...
			Codakid.spawnItem(world, pos, Main.radiantIngot, 67);
