...
public class EnchantmentExperienceBoost extends Enchantment {
	public EnchantmentExperienceBoost() {
...
//            	player.experienceTotal+=level;
            	player.addExperience(level*level);
            }
        }
    }
