...
public class EnchantmentShield extends Enchantment {
//	private String unlocalizedName;
	public EnchantmentShield() {
...
//    		}
//    	}
    	return (stack.getItem() instanceof ItemArmor && stack.getItem().isValidArmor(stack, EntityEquipmentSlot.CHEST, null)) ? true : super.canApply(stack);
    }
    ...
    public void onUserHurt(EntityLivingBase user, Entity attacker, int level)
    {
        ...
        ItemStack itemstack = EnchantmentHelper.getEnchantedItem(Main.shieldEnchant, user);
        if (level >= 5) {
