...
public class EntityDestructionEraserGrenadeA extends EntityThrowable {

	public EntityDestructionEraserGrenadeA(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityDestructionEraserGrenadeA(World worldIn) {
		super(worldIn);
	}
