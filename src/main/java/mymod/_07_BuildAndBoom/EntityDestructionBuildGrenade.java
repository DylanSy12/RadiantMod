...
public class EntityDestructionBuildGrenade extends EntityThrowable {

	public EntityDestructionBuildGrenade(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityDestructionBuildGrenade(World worldIn) {
		super(worldIn);
	}
