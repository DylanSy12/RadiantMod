...
public class RadiantBuildGrenade extends Item{
	
	public RadiantBuildGrenade() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn){
		...
		if(!worldIn.isRemote) {
			EntityRadiantBuildGrenade grenade = new EntityRadiantBuildGrenade(worldIn, playerIn);
