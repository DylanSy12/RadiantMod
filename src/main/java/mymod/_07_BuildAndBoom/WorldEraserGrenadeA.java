...
public class WorldEraserGrenadeA extends Item{
	
	public WorldEraserGrenadeA() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn){
		...
		if(!worldIn.isRemote) {
			EntityWorldEraserGrenadeA grenade = new EntityWorldEraserGrenadeA(worldIn, playerIn);
