...
public class EntityRadiantClusterGrenadeFragment extends EntityThrowable {

	public EntityRadiantClusterGrenadeFragment(World worldIn, double x, double y, double z, double motX, double motY,
			double motZ) {
		super(worldIn, x, y, z);
		this.setVelocity(motX, motY, motZ);
	}

	public EntityRadiantClusterGrenadeFragment(World worldIn) {
		super(worldIn);
	}
