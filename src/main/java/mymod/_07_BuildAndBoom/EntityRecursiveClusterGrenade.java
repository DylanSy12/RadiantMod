...
public class EntityRecursiveClusterGrenade extends EntityThrowable {

	public EntityRecursiveClusterGrenade(World worldIn, double x, double y, double z, double motX, double motY,
			double motZ) {
		super(worldIn, x, y, z);
		this.setVelocity(motX, motY, motZ);
	}
	
	public EntityRecursiveClusterGrenade(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityRecursiveClusterGrenade(World worldIn) {
		super(worldIn);
	}
