...
public class EntityMysticalEraserGrenade extends EntityThrowable {

	public EntityMysticalEraserGrenade(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityMysticalEraserGrenade(World worldIn) {
		super(worldIn);
	}
