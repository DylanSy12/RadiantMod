...
public class EntityWorldEndGrenade extends EntityThrowable {
	int recursions = 0;
	public EntityWorldEndGrenade(World worldIn, double x, double y, double z, double motX, double motY,
			double motZ, int recursions) {
		super(worldIn, x, y, z);
		this.setVelocity(motX, motY, motZ);
		this.recursions = recursions;
	}
	
	public EntityWorldEndGrenade(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityWorldEndGrenade(World worldIn) {
		super(worldIn);
	}
