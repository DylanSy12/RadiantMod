...
public class EntityWorldEraserGrenade extends EntityThrowable {

	public EntityWorldEraserGrenade(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityWorldEraserGrenade(World worldIn) {
		super(worldIn);
	}
	
	public EntityWorldEraserGrenade(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	}
