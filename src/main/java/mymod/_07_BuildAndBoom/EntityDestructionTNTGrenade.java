...
public class EntityDestructionTNTGrenade extends EntityThrowable {

	public EntityDestructionTNTGrenade(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityDestructionTNTGrenade(World worldIn) {
		super(worldIn);
	}
