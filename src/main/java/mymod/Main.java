...
public class Main {
    ...
    public static RadiantArmor myHelmet;
    public static RadiantArmor myChestplate;
    public static RadiantArmor chestplate1;
    public static RadiantArmor myLeggings;
    public static RadiantArmor myBoots;
    ...
    public static RadiantSword mySword;
...
//    public static final UUID MAX_HEALTH_UUID = UUID.fromString("01712f7e-776c-4d28-a28f-0fe6cb491ad9");
    ...
    public void preInit(FMLPreInitializationEvent event) {
    	...
    	myHelmet = new RadiantArmor(1, EntityEquipmentSlot.HEAD);
    	myChestplate = new RadiantArmor(1, EntityEquipmentSlot.CHEST);
    	myLeggings = new RadiantArmor(2, EntityEquipmentSlot.LEGS);
    	myBoots = new RadiantArmor(1, EntityEquipmentSlot.FEET);
    	myPickaxe = new CustomPickaxe();
    	mySword = new RadiantSword();
    	myOre = new CustomOre();
