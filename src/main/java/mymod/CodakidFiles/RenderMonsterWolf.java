...
public class RenderMonsterWolf extends RenderLiving {

	private static final ResourceLocation wolfTexture = new ResourceLocation(
			Main.MODID, "mobs/wolf_texture.png");
	
	public static final Factory FACTORY = new Factory();
	
	public RenderMonsterWolf(RenderManager renderManager) {
		super(renderManager, new BossModelWolf(), 0.5f);
	}
