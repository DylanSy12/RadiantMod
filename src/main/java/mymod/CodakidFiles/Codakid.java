...
public class Codakid {	 
    ...
    private static ArrayList<Enchantment> enchantmentsToRegister = new ArrayList<Enchantment>();
...
//	public static void registerItemStack(ItemStack stack,String registryName) {
//		stack.setsetRegistryName(registryName);
//		stack.setUnlocalizedName(Main.MODID + "." + registryName);
//		itemsToRegister.add(stack);
//	}
	public static void registerEnchantment(Enchantment enchantment,String registryName,String name) {
		enchantment.setRegistryName(registryName);
//		enchantment.setName(name);
//		enchantment.setUnlocalizedName(Main.MODID + "." + registryName);
//		enchantment.setRegistryName("foundations", registryName);
	...
	public static void doEnchantmentRegistry(RegistryEvent.Register<Enchantment> event) {
//		event.getRegistry().registerAll(enchantmentsToRegister.toArray(new Enchantment[enchantmentsToRegister.size()]));
