...
public class MysticalBiome extends Biome {
	
	private static BiomeProperties properties = new Biome.BiomeProperties("Mystical Land");
	static {
...
//		properties.setTemperature(0f);
	...
	public MysticalBiome() {
		super(properties);
		this.setRegistryName(new ResourceLocation(Main.MODID, "mystical_biome"));
	}
