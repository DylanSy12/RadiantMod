...
public class WorldErasingGrenade extends Item{
	
	public WorldErasingGrenade() {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn){
		...
		if(!worldIn.isRemote) {
			EntityWorldErasingGrenade grenade = new EntityWorldErasingGrenade(worldIn, playerIn);
