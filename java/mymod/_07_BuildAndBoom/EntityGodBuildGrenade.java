...
public class EntityGodBuildGrenade extends EntityThrowable {

	public EntityGodBuildGrenade(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityGodBuildGrenade(World worldIn) {
		super(worldIn);
	}
