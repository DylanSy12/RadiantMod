...
public class EntityWorldEraserGrenadeA extends EntityThrowable {

	public EntityWorldEraserGrenadeA(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityWorldEraserGrenadeA(World worldIn) {
		super(worldIn);
	}
