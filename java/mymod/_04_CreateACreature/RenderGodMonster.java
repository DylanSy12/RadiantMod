...
public class RenderGodMonster extends RenderBiped<GodMonster> {
...
//			Main.MODID, "mobs/god_biped_texture.png");
	...
	public RenderGodMonster(RenderManager renderManager) {
...
//	}
	...
	public static class Factory implements IRenderFactory<GodMonster> {

        @Override
        public Render<? super GodMonster> createRenderFor(RenderManager manager) {
            return new RenderGodMonster(manager);
        }

    }
	protected ResourceLocation getEntityTexture(GodMonster entity)
    {
        return mobTexture;
    }
}
